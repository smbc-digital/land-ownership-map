const Land_Ownership_Popup = (feature, layer) => {
  const content = `<div class="item"><i class="far fa-image"></i><p class="title">Land Ownership</p>
    <p></p>
...
const Leases_Popup = (feature, layer) => {
  const content = `<div class="item"><i class="fas fa-file-contract"></i><p class="title">Leases</p>
    <p></p>
